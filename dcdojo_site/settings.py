"""
Django settings for dcdojo_site project on Heroku. Fore more info, see:
...
ROOT_URLCONF = 'dcdojo_site.urls'

TEMPLATES = (
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
        # /Users/ndanielsen/Projects/dcpythondojo/dcdojo_sitedcdojo_site/base.html
        BASE_DIR + '/dcdojo_site/templates/'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'dcdojo_site.wsgi.application'
...
ALLOWED_HOSTS = ['localhost:5000', 'dcpythondojo.herokuapp.com/' ]
